...
XavierInit(weightsBuffer, count: hiddenDim * (2 * hiddenDim + 1), fanIn: (2 * hiddenDim + 1), fanOut: hiddenDim)
XavierInit(biasBuffer, count: hiddenDim, fanIn: hiddenDim, fanOut: 1)
XavierInit(coordWeightBuffer, count: hiddenDim, fanIn: hiddenDim, fanOut: 1)
XavierInit(nodeWBuffer, count: hiddenDim * 2 * hiddenDim, fanIn: 2 * hiddenDim, fanOut: hiddenDim)
XavierInit(nodeBBuffer, count: hiddenDim, fanIn: hiddenDim, fanOut: 1)
